...
scan-build.stamp: ts $(HFILE_GLOB) $(CFILE_GLOB)
	...
	PATH="$(abs_top_builddir)$(PATH_SEPARATOR)$(PATH)" PERL5LIB="$(abs_top_builddir)$(PATH_SEPARATOR)$(PERL5LIB)" \
...
html-build.stamp: sgml.stamp $(DOC_MAIN_SGML_FILE) $(content_files)
	...
	cd html && PATH="$(abs_top_builddir)$(PATH_SEPARATOR)$(PATH)" PERL5LIB="$(abs_top_builddir)$(PATH_SEPARATOR)$(PERL5LIB)" ABS_TOP_SRCDIR=$(abs_top_srcdir) \
...
pdf-build.stamp: sgml.stamp $(DOC_MAIN_SGML_FILE) $(content_files)
	...
	PATH="$(abs_top_builddir)$(PATH_SEPARATOR)$(PATH)" PERL5LIB="$(abs_top_builddir)$(PATH_SEPARATOR)$(PERL5LIB)" ABS_TOP_SRCDIR=$(abs_top_srcdir) \
